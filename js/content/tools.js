...
export const TOOLS = {
  ...
  wood_shovel:  { id: 'wood_shovel', name: 'Wood Shovel', power: 2.0, durability: 70, mineBonus: [BLOCK.DIRT, BLOCK.GRASS, BLOCK.SAND, BLOCK.SNOW, BLOCK.CLAY], damage: 5, reach: 1.5, shovel: true },
  stone_shovel: { id: 'stone_shovel', name: 'Stone Shovel', power: 3.2, durability: 140, mineBonus: [BLOCK.DIRT, BLOCK.GRASS, BLOCK.SAND, BLOCK.SNOW, BLOCK.CLAY], damage: 6, reach: 1.5, shovel: true },
  iron_shovel:  { id: 'iron_shovel', name: 'Iron Shovel', power: 4.8, durability: 280, mineBonus: [BLOCK.DIRT, BLOCK.GRASS, BLOCK.SAND, BLOCK.SNOW, BLOCK.CLAY], damage: 7, reach: 1.5, shovel: true },
