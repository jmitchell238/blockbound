...
export const RECIPES = [
  ...
  { id: 'lantern', name: 'Lantern', station: 'workbench', in: [['iron_ingot', 1], [BLOCK.TORCH, 1], [BLOCK.GLASS, 1]], out: [BLOCK.LANTERN, 1] },
  ...
  { id: 'wood_shovel', name: 'Wood Shovel', station: 'workbench', in: [[BLOCK.PLANKS, 1], ['stick', 2]], out: ['wood_shovel', 1] },
  ...
  { id: 'stone_shovel', name: 'Stone Shovel', station: 'workbench', in: [[BLOCK.STONE, 1], ['stick', 2]], out: ['stone_shovel', 1] },
  ...
  { id: 'iron_shovel', name: 'Iron Shovel', station: 'workbench', in: [['iron_ingot', 1], ['stick', 2]], out: ['iron_shovel', 1] },
