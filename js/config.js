...
const TOOLS = {
  hand:      { id: 'hand', name: 'Hands', power: 1, durability: Infinity },
  wood_pick: { id: 'wood_pick', name: 'Wood Pickaxe', power: 2.2, durability: 80, mineBonus: [BLOCK.STONE, BLOCK.COAL, BLOCK.COPPER] },
  stone_pick:{ id: 'stone_pick', name: 'Stone Pickaxe', power: 3.5, durability: 160, mineBonus: [BLOCK.STONE, BLOCK.COAL, BLOCK.IRON, BLOCK.COPPER] },
  iron_pick: { id: 'iron_pick', name: 'Iron Pickaxe', power: 5.5, durability: 320, mineBonus: [BLOCK.STONE, BLOCK.COAL, BLOCK.IRON, BLOCK.GOLD, BLOCK.COPPER] },
  gold_pick: { id: 'gold_pick', name: 'Gold Pickaxe', power: 7.5, durability: 200, mineBonus: [BLOCK.STONE, BLOCK.COAL, BLOCK.IRON, BLOCK.GOLD, BLOCK.COPPER] },
  wood_axe:  { id: 'wood_axe', name: 'Wood Axe', power: 2.5, durability: 80, mineBonus: [BLOCK.WOOD, BLOCK.LEAVES, BLOCK.PLANKS, BLOCK.DOOR, BLOCK.CHEST] },
  stone_axe: { id: 'stone_axe', name: 'Stone Axe', power: 3.8, durability: 160, mineBonus: [BLOCK.WOOD, BLOCK.LEAVES, BLOCK.PLANKS, BLOCK.DOOR, BLOCK.CHEST] },
  iron_axe:  { id: 'iron_axe', name: 'Iron Axe', power: 5.2, durability: 300, mineBonus: [BLOCK.WOOD, BLOCK.LEAVES, BLOCK.PLANKS, BLOCK.DOOR, BLOCK.CHEST, BLOCK.BED] },
};
